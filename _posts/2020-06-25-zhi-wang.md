...
{% highlight cuda wl linenos %}
/**
 Pairwise quadrupole electrostatics.
 @tparam Version   Flag for using energy counts,
                   potential energy, virial tensor,
                   and energy gradient in the pairwise
                   interaction.
 @tparam ElecType  Flag for using real space PME or
                   Non-EWALD pairwise interaction.
 */
template <class Version, class ElecType>
__device__
void pair_mpole(CUDA_KERNEL_ARGUMENTS)
{
   // flag for number of interactions
   constexpr bool do_a = Version::a;
   // flag for potential energy
   constexpr bool do_e = Version::e;
   // flag for virial tensor
   constexpr bool do_v = Version::v;
   // flag for energy gradient
   constexpr bool do_g = Version::g;
